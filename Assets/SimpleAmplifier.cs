...
#if UNITY_EDITOR
    [CustomEditor(typeof(Photon.Voice.Unity.UtilityScripts.SimpleAmplifier))]
    public class SimpleAmplifierEditor : Editor
    {
        private Photon.Voice.Unity.UtilityScripts.SimpleAmplifier simpleAmplifier;

        private void OnEnable()
        {
            this.simpleAmplifier = this.target as Photon.Voice.Unity.UtilityScripts.SimpleAmplifier;
        }
